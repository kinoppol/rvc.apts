...
$statusMap = [
    ...
    'suspended' => ['ระงับสิทธิ์', 'badge-susp'],
];
[$statusLabel, $statusBadge] = $statusMap[$user['status']] ?? $statusMap['approved'];

$activeNav = 'profile';
require __DIR__ . '/../includes/header.php';
?>
<h5 style="font-weight:700;margin:0 0 20px">โปรไฟล์ส่วนตัว</h5>
